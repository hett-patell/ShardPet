...
const NAMES_BY_ID: Readonly<Record<number, string>> = {
...
export const NAME_BY_ID: Readonly<Record<number, string>> = NAMES_BY_ID;

export const POKEMON_LIST: ReadonlyArray<PokemonEntry> = Object.entries(NAMES_BY_ID)
